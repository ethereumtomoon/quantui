...
import TopicAside from './aside/components/TopicAsideNav.vue'
import TopicContent from './content/TopicContent.vue'
...
const ReplyPanel = defineAsyncComponent(
  () => import('./content/components/ReplyPanel.vue')
)
  ...
  <div class="main-wrapper">
    ...
    <div class="topic-wrapper">
      ...
      <div class="content-wrapper">
        <TopicAside class="aside" style="margin-right: 10px" />
        <TopicContent />
      </div>
    </div>
  </div>
