...
.search-btn {
  ...
  width: 39px;
  flex-shrink: 0;
  border-left: 1px solid var(--forum-trans-blue-4);
  /* 搜索图标居中 */
  display: flex;
  justify-content: center;
  align-items: center;
  ...
  font-size: 18px;
  &:hover {
    background-color: var(--forum-red-2);
  }
  &:active {
...
.history {
  ...
  color: var(--forum-font-color-3);
  border: 1px solid var(--forum-red-1);
  border-radius: 7px;
...
.title {
  ...
  span {
    ...
    &:nth-child(2) {
      cursor: pointer;
      border-bottom: 1.5px solid var(--forum-trans-white-5);
      &:hover {
        border-bottom: 1.5px solid var(--forum-blue-4);
      }
    }
  }
}
